...
INSERT INTO `admin_notification_logs` VALUES (10,2,'all',5,'Documents','please upload your documents on app',1,0,'2026-09-01 14:47:03');
...
INSERT INTO `admin_permissions` VALUES (29,7,'tenants',1,0,0,0,'2026-09-01 14:37:05'),(30,7,'guests',0,0,0,0,'2026-09-01 14:37:05'),(31,7,'bills',1,0,1,0,'2026-09-01 14:37:05'),(32,7,'pgs',0,0,0,0,'2026-09-01 14:37:05'),(33,7,'maintenance',1,0,1,0,'2026-09-01 14:37:05'),(34,7,'documents',0,0,0,0,'2026-09-01 14:37:05'),(35,7,'feedbacks',0,0,0,0,'2026-09-01 14:37:05');
...
INSERT INTO `admins` VALUES (1,'MO11','molittle1011@gmail.com',NULL,'$2b$12$ERndXqISwxL48Vc/RDNhHe0iUhM1omZiqdvOppqFkORhIKX.ZLc/u',0,'super_admin',NULL,NULL,NULL,NULL,NULL,1,'2026-08-22 10:23:04','2026-09-21 05:43:57','2026-09-21 05:43:36',NULL,NULL),(2,'Livinkey Admin','livinkey@gmail.com',NULL,'$2b$12$jPhjgye4s7ASgXnRx8s/qO5Lu9GT7NNA0DhN8xGn4mc1zD5dHLv.6',0,'super_admin',NULL,NULL,NULL,NULL,NULL,1,'2026-08-22 20:44:41','2026-09-07 14:39:52','2026-09-07 14:39:02',NULL,NULL),(7,'Asif Ali Mir','miraasif2477@gmail.com','7889743773','$2b$12$wGFA0uQwLepYrYLmRhhwgeWFl69.Zw17m1jgk5rVeSjhSiTG2Og66',0,'admin',NULL,NULL,NULL,NULL,NULL,1,'2026-09-01 14:37:05','2026-09-01 14:50:24','2026-09-01 14:50:10',NULL,NULL);
...
-- Dump completed on 2026-09-23 18:50:06


-- ============================================================
-- Livinkey Activity Tracking / Audit Trail (safe migration)
-- Runtime also verifies this schema on backend startup.
-- ============================================================
...
ALTER TABLE admin_permissions ADD COLUMN IF NOT EXISTS can_message TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE admin_permissions ADD COLUMN IF NOT EXISTS can_export TINYINT(1) NOT NULL DEFAULT 0;
